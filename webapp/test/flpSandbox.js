		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Assortment Maintenance Tool",
									"targetURL": "#comamtassortmentmaintenancetool-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamtassortmentmaintenancetool-display": {
								"semanticObject": "comamtassortmentmaintenancetool",
								"action": "display",
								"description": "AMT",
								"title": "Assortment Maintenance Tool",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.amt.assortmentmaintenancetool",
									"url": sap.ui.require.toUrl("com/amt/assortmentmaintenancetool")
								}
							}
						}
					}
